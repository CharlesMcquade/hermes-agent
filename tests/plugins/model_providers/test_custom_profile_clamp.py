...
class TestCustomProfileClampIntegration:
    ...
    def test_disabled_reasoning_emits_none(self, custom_profile, monkeypatch):
        ...
        # Merged contract (upstream Ollama gating × fork clamp merge):
        # think=False is emitted only for explicit Ollama endpoints; strict
        # hosts (GLM SGLang, vLLM, Mistral) 422 on the Ollama-native flag.
        assert "think" not in extra_body
